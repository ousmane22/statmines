...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('front/assets/images/favicon.png') }}" />
   ...
   <link href="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/css/select2.min.css" rel="stylesheet" />
    ...
    {{-- <script src="{{ asset('dropsown/cdn') }}></script> --}}
    @livewireStyles
</head>
...
<body>
                ...
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <a class="navbar-brand" href="index.html">
                        ...
                        <b class="logo-icon ps-2">
                            ...
                            <!-- Dark Logo icon -->
                            <img src="{{ asset('front/assets/images/logo-icon.png') }}" alt="homepage"
                        ...
                        <span class="logo-text ms-2">
                            <!-- dark Logo text -->
                            {{-- <img
                  src="{{ asset('front/assets/images/logo-text.png')}}"
                  alt="homepage"
                  class="light-logo" --}}
                            {{-- /> --}}
                            <h6 class="mt-3">STATMINES</h6>
                        </span>
                        <!-- Logo icon -->
                        <!-- <b class="logo-icon"> -->
                        <!--You can put here icon as well // <i class="wi wi-sunset"></i> //-->
    ...
    <script src="{{ asset('front/assets/extra-libs/sparkline/sparkline.js') }}"></script>
    <!--Wave Effects -->
    <script src="{{ asset('front/dist/js/waves.js') }}"></script>
    <!--Menu sidebar -->
    <script src="{{ asset('front/dist/js/sidebarmenu.js') }}"></script>
    <!--Custom JavaScript -->
    <script src="{{ asset('front/dist/js/custom.min.js') }}"></script>
    <!--This page JavaScript -->
    <!-- <script src="{{ asset('front/dist/js/pages/dashboards/dashboard1.js') }}"></script> -->
    <!-- Charts js Files -->

    <script type="text/javascript" src="{{ asset('DataTables/datatables.min.js') }}"></script>
    <script src="{{ asset('front/assets/libs/flot/excanvas.js') }}"></script>
    <script src="{{ asset('front/assets/libs/flot/jquery.flot.js') }}"></script>
    <script src="{{ asset('front/assets/libs/flot/jquery.flot.pie.js') }}"></script>
    <script src="{{ asset('front/assets/libs/flot/jquery.flot.time.js') }}"></script>
    <script src="{{ asset('front/assets/libs/flot/jquery.flot.stack.js') }}"></script>
