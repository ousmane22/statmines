<div>
    ...
    @endif
    <div wire:ignore.self class="modal fade" id="formulaire" data-backdrop='static' data-keyboard='false' tabindex="-1"
                ...
                <div class="modal-body">
                    <form wire:submit.prevent="storeFormulaire">
                        <div class="form-group">
                            ...
                            <input type="text" hidden readonly id="" class="form-control"
                                wire:model="IDtitreminier" value="{{ $IDtitreminier }}">
